...
- [x] Fresh gate / exact base and packet / baseline891+142
- [x] Versioned schemas and explicit routes / legacy bytes
- [x] Decimal FAR stack / null fail closed / review and provenance
- [x] Search exact copy / effective caps / zero accepted
- [x] Run Package0.1/0.2 create + verify / matrix / atomic guards
