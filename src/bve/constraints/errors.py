...
class Code(StrEnum):
    ...
    DUPLICATE_CAP_ID = "DUPLICATE_CAP_ID"
    DUPLICATE_HEIGHT_CAP_ID = "DUPLICATE_HEIGHT_CAP_ID"
    CONSTRAINT_SCHEMA_INVALID = "CONSTRAINT_SCHEMA_INVALID"
    CONSTRAINT_SEMANTIC_MISMATCH = "CONSTRAINT_SEMANTIC_MISMATCH"
